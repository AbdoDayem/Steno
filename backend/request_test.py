...
r = requests.post('http://localhost:5001/audio')
'''
r = requests.get('http://localhost:5001/status')
print(r.content)
...
print(r.content)
r = requests.post('http://localhost:5001/url',data=U)
r = requests.get('http://localhost:5001/url')
print(r.content)
